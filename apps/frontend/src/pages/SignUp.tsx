...
export const Signup = () => {
    ...
    return (
        <AuthWrapper title="Join Chess Masters">
            {error && (
                <motion.div 
            ...
            >
                ...
                <span className="text-xs text-center text-slate-400 uppercase tracking-wider">or sign up with</span>
                <span className="border-t border-slate-600 w-1/5 lg:w-1/4"></span>
            </motion.div>
            ...
            >
                ...
                <a href="/login" className="text-blue-400 hover:text-blue-300 ml-1 transition-colors font-medium hover:underline">
                    Login
                </a>
            </motion.p>
        </AuthWrapper>
